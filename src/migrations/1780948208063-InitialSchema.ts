...
export class InitialSchema1780948208063 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_monthly_budgets_user_period" ON "monthly_budgets" ("userId", "year", "month")`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_transactions_user_category" ON "transactions" ("userId", "categoryId")`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_transactions_user_type_date" ON "transactions" ("userId", "type", "date")`,
    );
    await queryRunner.query(
